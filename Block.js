...
function Shape(grid, size, color) {
    ...
    this.element = function() {
        ...
        for(let i = 0; i < this.blocks.length; ++i) {
            ...
            inner.style.left = parseInt(block.ShapePos.x)+parseInt(block.Point.x) + "px";
            inner.style.top  = parseInt(block.ShapePos.y)+parseInt(block.Point.y) + "px";
            inner.style.border = "0px solid #444444";
